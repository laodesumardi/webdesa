...
@section('content')
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12">
        <div class="scroll-animate bg-white rounded-xl border border-gray-200 p-6 text-center hover:border-[#1e3a8a] hover:shadow-lg transition-all duration-300" data-animation="fade-up" data-delay="100">
            ...
            <div class="text-3xl md:text-4xl font-bold text-[#1e3a8a] mb-2">25</div>
            <div class="text-sm md:text-base text-gray-600 font-medium">UMKM Terdaftar</div>
        </div>
        <div class="scroll-animate bg-white rounded-xl border border-gray-200 p-6 text-center hover:border-[#1e3a8a] hover:shadow-lg transition-all duration-300" data-animation="fade-up" data-delay="200">
            <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                </svg>
            </div>
            <div class="text-3xl md:text-4xl font-bold text-[#1e3a8a] mb-2">8</div>
            <div class="text-sm md:text-base text-gray-600 font-medium">Kategori Usaha</div>
        </div>
        <div class="scroll-animate bg-white rounded-xl border border-gray-200 p-6 text-center hover:border-[#1e3a8a] hover:shadow-lg transition-all duration-300" data-animation="fade-up" data-delay="300">
            ...
            <div class="text-3xl md:text-4xl font-bold text-[#1e3a8a] mb-2">4</div>
            <div class="text-sm md:text-base text-gray-600 font-medium">Program Aktif</div>
        </div>
        <div class="scroll-animate bg-white rounded-xl border border-gray-200 p-6 text-center hover:border-[#1e3a8a] hover:shadow-lg transition-all duration-300" data-animation="fade-up" data-delay="400">
    ...
    <div class="mb-12 scroll-animate" data-animation="fade-up" data-delay="100">
        <div class="mb-8">
            ...
            <div class="flex flex-wrap gap-2 mb-6">
                <button class="filter-btn active px-5 py-2.5 bg-[#1e3a8a] text-white text-sm font-medium hover:bg-blue-900 transition-all rounded-lg shadow-sm" data-filter="all">
                    Semua
                </button>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="umkm-grid">
            <!-- UMKM 1 -->
            <div class="umkm-card scroll-animate bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1e3a8a] hover:shadow-xl transition-all duration-300 group cursor-pointer" data-animation="scale-fade" data-delay="200" data-category="kerajinan">
                <div class="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="bg-[#1e3a8a] text-white px-3 py-1.5 text-xs font-semibold rounded-lg shadow-md">Kerajinan</span>
                    </div>
                </div>
                <div class="p-5">
                    <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1e3a8a] transition-colors line-clamp-1">Kerajinan Tangan Anyaman</h3>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="tel:081234567890" class="bg-[#1e3a8a] text-white px-4 py-2 text-sm font-medium hover:bg-[#1e3a8a] transition-colors inline-flex items-center gap-2 rounded-lg shadow-sm">
            ...
            <!-- UMKM 2 -->
            <div class="umkm-card scroll-animate bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1e3a8a] hover:shadow-xl transition-all duration-300 group cursor-pointer" data-animation="scale-fade" data-delay="300" data-category="makanan">
                <div class="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1e3a8a] transition-colors line-clamp-1">Makanan Khas Desa</h3>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="tel:081234567891" class="bg-[#1e3a8a] text-white px-4 py-2 text-sm font-medium hover:bg-[#1e3a8a] transition-colors inline-flex items-center gap-2 rounded-lg shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Hubungi
            ...
            <!-- UMKM 3 -->
            <div class="umkm-card scroll-animate bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1e3a8a] hover:shadow-xl transition-all duration-300 group cursor-pointer" data-animation="scale-fade" data-delay="400" data-category="fashion">
                <div class="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1e3a8a] transition-colors line-clamp-1">Batik Tulis Eksklusif</h3>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="tel:081234567892" class="bg-[#1e3a8a] text-white px-4 py-2 text-sm font-medium hover:bg-[#1e3a8a] transition-colors inline-flex items-center gap-2 rounded-lg shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Hubungi
            ...
            <!-- UMKM 4 -->
            <div class="umkm-card scroll-animate bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1e3a8a] hover:shadow-xl transition-all duration-300 group cursor-pointer" data-animation="scale-fade" data-delay="500" data-category="makanan">
                <div class="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1e3a8a] transition-colors line-clamp-1">Olahan Pangan Lokal</h3>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="tel:081234567893" class="bg-[#1e3a8a] text-white px-4 py-2 text-sm font-medium hover:bg-[#1e3a8a] transition-colors inline-flex items-center gap-2 rounded-lg shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Hubungi
            ...
            <!-- UMKM 5 -->
            <div class="umkm-card scroll-animate bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1e3a8a] hover:shadow-xl transition-all duration-300 group cursor-pointer" data-animation="scale-fade" data-delay="600" data-category="jasa">
                <div class="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1e3a8a] transition-colors line-clamp-1">Jasa Cukur Rambut</h3>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="tel:081234567894" class="bg-[#1e3a8a] text-white px-4 py-2 text-sm font-medium hover:bg-[#1e3a8a] transition-colors inline-flex items-center gap-2 rounded-lg shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Hubungi
            ...
            <!-- UMKM 6 -->
            <div class="umkm-card scroll-animate bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1e3a8a] hover:shadow-xl transition-all duration-300 group cursor-pointer" data-animation="scale-fade" data-delay="700" data-category="perdagangan">
                <div class="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1e3a8a] transition-colors line-clamp-1">Toko Kelontong</h3>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="tel:081234567895" class="bg-[#1e3a8a] text-white px-4 py-2 text-sm font-medium hover:bg-[#1e3a8a] transition-colors inline-flex items-center gap-2 rounded-lg shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Hubungi
    ...
    <div class="mb-12 scroll-animate bg-white rounded-2xl border border-gray-200 p-8 md:p-10 shadow-lg" data-animation="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="scroll-animate bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 rounded-xl p-6 hover:border-blue-400 hover:shadow-lg transition-all duration-300" data-animation="fade-up" data-delay="100">
                <div class="flex items-start gap-4">
                    <div class="bg-[#1e3a8a] p-4 rounded-xl flex-shrink-0">
