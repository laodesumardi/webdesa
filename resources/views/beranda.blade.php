...
@section('content')
    ...
    <div class="relative bg-gradient-to-br from-[#1e3a8a] via-blue-900 to-[#1e3a8a] text-white mb-16 overflow-hidden rounded-2xl shadow-2xl">
        <div id="hero-slider" class="flex transition-transform duration-700 ease-in-out h-full min-h-[500px] md:min-h-[600px]">
            ...
            <div class="min-w-full relative px-4 py-16 md:py-24 flex items-center">
                ...
                <!-- Gradient Overlay -->
                <div class="absolute inset-0 bg-gradient-to-br from-[#1e3a8a]/85 via-[#1e3a8a]/75 to-[#1e3a8a]/85"></div>
                <!-- Pattern Overlay -->
                ...
                <div class="container mx-auto text-center relative z-10 max-w-5xl">
                    <div class="inline-block mb-6 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                        <span class="text-sm font-medium">Selamat Datang</span>
                    </div>
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight hero-title-animate">
                        Website Resmi<br>
                        <span class="text-blue-200">Pemerintah Desa</span>
                    </h1>
                    <p class="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto mb-8 hero-text-animate leading-relaxed">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 hero-buttons-animate">
                        <a href="{{ route('layanan') }}" class="px-6 py-3 bg-white text-[#1e3a8a] font-semibold rounded-lg hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            Layanan Desa
                        </a>
                        <a href="{{ route('berita') }}" class="px-6 py-3 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-lg border-2 border-white/30 hover:bg-white/20 transition-all">
                            Berita Terbaru
                        </a>
                    </div>
                </div>
            ...
            <div class="min-w-full relative px-4 py-16 md:py-24 flex items-center">
                ...
                <div class="container mx-auto text-center relative z-10 max-w-5xl">
                    <div class="inline-block mb-6 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                        <span class="text-sm font-medium">Pelayanan Publik</span>
                    </div>
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight hero-title-animate">
                        Transparansi &<br>
                        <span class="text-blue-200">Akuntabilitas</span>
                    </h1>
                    <p class="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto mb-8 hero-text-animate leading-relaxed">
                        Informasi layanan administrasi dan program desa tersedia untuk seluruh masyarakat dengan mudah dan cepat
                    </p>
                    <div class="flex flex-wrap justify-center gap-4 hero-buttons-animate">
                        <a href="{{ route('data') }}" class="px-6 py-3 bg-white text-[#1e3a8a] font-semibold rounded-lg hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            Data Desa
                        </a>
                        <a href="{{ route('kontak') }}" class="px-6 py-3 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-lg border-2 border-white/30 hover:bg-white/20 transition-all">
                            Hubungi Kami
                        </a>
                    </div>
                </div>
            ...
            <div class="min-w-full relative px-4 py-16 md:py-24 flex items-center">
                ...
                <div class="container mx-auto text-center relative z-10 max-w-5xl">
                    <div class="inline-block mb-6 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                        <span class="text-sm font-medium">Pembangunan Desa</span>
                    </div>
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight hero-title-animate">
                        Partisipasi<br>
                    ...
                    <div class="flex flex-wrap justify-center gap-4 hero-buttons-animate">
                        <a href="{{ route('umkm') }}" class="px-6 py-3 bg-white text-[#1e3a8a] font-semibold rounded-lg hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            Ekonomi & UMKM
                        </a>
                        <a href="{{ route('galeri') }}" class="px-6 py-3 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-lg border-2 border-white/30 hover:bg-white/20 transition-all">
                            Galeri Kegiatan
                        </a>
                    </div>
                </div>
        ...
        <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-3 z-10 hero-dots-animate">
            <button class="hero-dot w-3 h-3 bg-white rounded-full opacity-50 hover:opacity-100 transition-all duration-300" data-slide="0"></button>
            <button class="hero-dot w-3 h-3 bg-white rounded-full opacity-50 hover:opacity-100 transition-all duration-300" data-slide="1"></button>
            <button class="hero-dot w-3 h-3 bg-white rounded-full opacity-50 hover:opacity-100 transition-all duration-300" data-slide="2"></button>
        </div>
    </div>
    ...
    <style>
        ...
        .hero-bg-1 {
            background-image: url('{{ file_exists(public_path('images/hero-1.jpg')) ? asset('images/hero-1.jpg') : 'https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=1920&q=80' }}');
        ...
        .hero-bg-2 {
            background-image: url('{{ file_exists(public_path('images/hero-2.jpg')) ? asset('images/hero-2.jpg') : 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=1920&q=80' }}');
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
        ...
        .hero-bg-3 {
            background-image: url('{{ file_exists(public_path('images/hero-3.jpg')) ? asset('images/hero-3.jpg') : 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=1920&q=80' }}');
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
